...
AxiosInstance.interceptors.response.use(
  ...
  async (error: AxiosError) => {
    ...
    if (
      ...
      try {
        const currentRefreshToken = localStorage.getItem('shell_cloud_token')
        ...
        if (res.data.refreshToken) {
          localStorage.setItem('shell_cloud_token', res.data.refreshToken)
        }
        ...
        localStorage.removeItem('shell_cloud_token')
