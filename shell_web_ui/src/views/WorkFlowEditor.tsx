...
function Editor() {
  ...
  const [workflowName, setWorkflowName] = useState('New Shell Macro')
  ...
  const resetCanvas = () => {
    setWorkflowName('New Shell Macro')
  ...
  return (
    <div className="flex h-full w-full bg-[#09090b] relative overflow-hidden">
      ...
      <button
        ...
        className={`absolute top-1/2 ${isSidebarOpen ? 'left-72' : 'left-0'} transform -translate-y-1/2 bg-[#111113] border border-[#27272a] border-l-0 p-2 rounded-r-lg text-zinc-600 hover:text-emerald-500 z-50 transition-all duration-300`}
      >
