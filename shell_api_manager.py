...
_KNOWN_KEYS: dict[str, dict] = {
    ...
    "SHELL_BLOCK_TERMINAL_EXEC":{"required": False, "section": "Safety",            "desc": "0/1 — disables terminal/PowerShell/Python execution tools."},
    "SHELL_BLOCK_WORKFLOW_COMMANDS":{"required": False, "section": "Safety",        "desc": "0/1 — disables workflow shell commands."},
    "SHELL_BLOCK_WORKFLOW_FILE_WRITE":{"required": False, "section": "Safety",      "desc": "0/1 — disables workflow file writes."},
    "SHELL_BLOCK_WORKFLOW_FILE_READ":{"required": False, "section": "Safety",       "desc": "0/1 — disables workflow file reads."},
    "SHELL_BLOCK_PROJECT_SCAFFOLD":{"required": False, "section": "Safety",         "desc": "0/1 — disables managed website/app scaffolds."},
